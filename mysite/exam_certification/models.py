...
class TimeFlightDiffractionTOFDLevel3_PCN_Material(models.Model):
    ...
    basic_a1 = models.ForeignKey(Samples,related_name="exam_material_fight_b1_theory_tofd_pcn1",  null=True, blank=True , on_delete=models.DO_NOTHING)
    basic_a2 = models.ForeignKey(Samples,related_name="exam_material_fight_sample_a2_tofd_pcn1",  null=True, blank=True , on_delete=models.DO_NOTHING)
    basic_b_part_1 = models.ForeignKey(Samples,related_name="exam_material_fight_sample_b1_tofd_pcn1",  null=True, blank=True , on_delete=models.DO_NOTHING)
    basic_b_part_2 = models.ForeignKey(Samples,related_name="exam_material_fight_sample_b2_tofd_pcn1",  null=True, blank=True , on_delete=models.DO_NOTHING)
    basic_b_part_3 = models.ForeignKey(Samples,related_name="exam_material_fight_sample_b3_tofd_pcn1",  null=True, blank=True , on_delete=models.DO_NOTHING)
    basic_b_part_4 = models.ForeignKey(Samples,related_name="exam_material_fight_sample_b4_tofd_pcn1",  null=True, blank=True , on_delete=models.DO_NOTHING)
    main_d = models.ForeignKey(Samples,related_name="exam_material_fight_sample_c1_tofd1",  null=True, blank=True , on_delete=models.DO_NOTHING)
    main_e = models.ForeignKey(Samples,related_name="exam_material_fight_sample_c2_tofd1",  null=True, blank=True , on_delete=models.DO_NOTHING)
    main_f = models.ForeignKey(Samples,related_name="exam_material_fight_sample_c3_tofd1",  null=True, blank=True , on_delete=models.DO_NOTHING)
    practical_tofd_l2 = models.ForeignKey(Samples,related_name="exam_material_flight_practical_tofd_swip1",  null=True, blank=True , on_delete=models.DO_NOTHING)
...
class PhasedArrayUltrasonicTesting_PAUT_L3_PCN_Material(models.Model):
    ...
    scheme = models.CharField(max_length=256, null=True, blank=True)
    exam_date = models.DateTimeField(max_length=256,null=True, blank=True)
    basic_a1 = models.ForeignKey(Samples,related_name="exam_material_ultera_b1_theory_paut",  null=True, blank=True , on_delete=models.DO_NOTHING)
    basic_a2 = models.ForeignKey(Samples,related_name="exam_material_ultera_sample_a2_paut",  null=True, blank=True , on_delete=models.DO_NOTHING)
    basic_b_part_1 = models.ForeignKey(Samples,related_name="exam_material_ultera_sample_b1_paut",  null=True, blank=True , on_delete=models.DO_NOTHING)
    basic_b_part_2 = models.ForeignKey(Samples,related_name="exam_material_ultera_sample_b2_paut",  null=True, blank=True , on_delete=models.DO_NOTHING)
    basic_b_part_3 = models.ForeignKey(Samples,related_name="exam_material_ultera_sample_b3_paut",  null=True, blank=True , on_delete=models.DO_NOTHING)
    basic_b_part_4 = models.ForeignKey(Samples,related_name="exam_material_ultera_sample_b4_paut",  null=True, blank=True , on_delete=models.DO_NOTHING)
    main_d = models.ForeignKey(Samples,related_name="exam_material_ultera_sample_c1_paut",  null=True, blank=True , on_delete=models.DO_NOTHING)
    main_e = models.ForeignKey(Samples,related_name="exam_material_ultera_sample_c2_paut",  null=True, blank=True , on_delete=models.DO_NOTHING)
    main_f = models.ForeignKey(Samples,related_name="exam_material_ultera_sample_c3_paut",  null=True, blank=True , on_delete=models.DO_NOTHING)
    practical_paut_l2 = models.ForeignKey(Samples,related_name="exam_material_ultera_practical_paut",  null=True, blank=True , on_delete=models.DO_NOTHING)
    delivery_method = models.CharField(max_length=256,null=True, blank=True)
    lecturer = models.CharField(max_length=256, null=True, blank=True)
    invigilator = models.CharField(max_length=256, null=True, blank=True)
    venue = models.CharField(max_length=256, null=True, blank=True)
...
class PhasedArrayUltrasonicTesting_PAUT_L3CSWIPMaterial(models.Model):
    ...
    scheme = models.CharField(max_length=256, null=True, blank=True)
    exam_date = models.DateTimeField(max_length=256,null=True, blank=True)
    basic_a1 = models.ForeignKey(Samples,related_name="exam_material_ultera_b1_theory_paut_pcn",  null=True, blank=True , on_delete=models.DO_NOTHING)
    basic_a2 = models.ForeignKey(Samples,related_name="exam_material_ultera_sample_a2_paut_pcn",  null=True, blank=True , on_delete=models.DO_NOTHING)
    basic_b_part_1 = models.ForeignKey(Samples,related_name="exam_material_ultera_sample_b1_paut_pcn",  null=True, blank=True , on_delete=models.DO_NOTHING)
    basic_b_part_2 = models.ForeignKey(Samples,related_name="exam_material_ultera_sample_b2_paut_pcn",  null=True, blank=True , on_delete=models.DO_NOTHING)
    basic_b_part_3 = models.ForeignKey(Samples,related_name="exam_material_ultera_sample_b3_paut_pcn",  null=True, blank=True , on_delete=models.DO_NOTHING)
    basic_b_part_4 = models.ForeignKey(Samples,related_name="exam_material_ultera_sample_b4_paut_pcn",  null=True, blank=True , on_delete=models.DO_NOTHING)
    main_c_1 = models.ForeignKey(Samples,related_name="exam_material_ultera_sample_d_paut",  null=True, blank=True , on_delete=models.DO_NOTHING)
    main_c_2 = models.ForeignKey(Samples,related_name="exam_material_ultera_sample_e_paut",  null=True, blank=True , on_delete=models.DO_NOTHING)
    main_c_3 = models.ForeignKey(Samples,related_name="exam_material_ultera_sample_f_paut",  null=True, blank=True , on_delete=models.DO_NOTHING)
    practical_paut_l2 = models.ForeignKey(Samples,related_name="exam_material_ultera_practical_paut_pcn",  null=True, blank=True , on_delete=models.DO_NOTHING)
    delivery_method = models.CharField(max_length=256,null=True, blank=True)
    lecturer = models.CharField(max_length=256, null=True, blank=True)
    invigilator = models.CharField(max_length=256, null=True, blank=True)
    venue = models.CharField(max_length=256, null=True, blank=True)
...
class ExamMaterialPhasedArrayUltrasonicTesting_PAUT_Level2PCN(models.Model):
    ...
    lecturer = models.CharField(max_length=256, null=True, blank=True)
    invigilator = models.CharField(max_length=256, null=True, blank=True)
    general_theory = models.ForeignKey(Samples,related_name="exam_material_ultera_sample_general_theory_pcn",  null=True, blank=True , on_delete=models.DO_NOTHING)
...
class CSWIPWeldingInspector3_1ExamMaterial(models.Model):
    ...
    remarks = models.CharField(max_length=4096,null=True, blank=True)
    file = models.FileField(upload_to='exam_result_file',null=True,blank=True)
    general_paper = models.ForeignKey(Samples,related_name="exam_material_31_sample_general_paper",  null=True, blank=True , on_delete=models.DO_NOTHING)
    technology_paper = models.ForeignKey(Samples,related_name="exam_material_31_sample_technology_paper",  null=True, blank=True , on_delete=models.DO_NOTHING)
