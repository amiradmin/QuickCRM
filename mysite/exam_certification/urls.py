...
urlpatterns = [
    ...
    path('updatepaintinginspectionexam/<int:id>', views.UpdateBGAS_CSWIP_PaintingInspector.as_view(), name='updatepaintinginspectionexam_'),
    ...
    path('updatescwipphasedarray/<int:id>', views.UpdateExamMaterialCSWIPPhasedArrayUltera.as_view(), name='updatescwipphasedarray_'),
    ...
    path('updatecswipexam321result/<int:id>', views.UpdateExamResultSwip321.as_view(), name='updatecswipexam321result_'),
    ...
    path('updateexampcnultral3result/<int:id>', views.UpdatePhasedArrayUltrasonicTesting_PAUT_L3_PCN_Result.as_view(), name='updateexampcnultral3result_'),
    ...
    path('updateexampcntofdl3material/<int:id>', views.UpdateTimeFlightDiffractionTOFDLevel3_PCN_Material.as_view(),
         name='updateexampcntofdl3material_'),
    ...
    path('updateexamrmaterial/<int:id>', views.UpdateRadiographicInterpretationWeldsRIMaterial.as_view(),
         name='updateexamrmaterial_'),
    ...
    path('updatematerialtofdl2pcnresult/<int:id>', views.Update_Result_PhasedArrayUltrasonicTesting_TOFD_Level2PCN.as_view(),
         name='updatematerialtofdl2pcnresult_'),
    ...
    path('updatematerialtofdl2cswipresult/<int:id>', views.Update_Result_ExamMaterialTOFD_CSWIP.as_view(),
         name='updatematerialtofdl2cswipresult_'),
