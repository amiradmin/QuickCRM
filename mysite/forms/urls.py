...
urlpatterns = [
    ...
    path('psl30logbyid/<int:id>/<int:eventID>/<int:formID>', views.UpdatePSL30LogExperienceByUserID.as_view(), name='psl30logbyid_'),
    ...
    path('newpsl57Abyid/<int:id>/<int:eventID>/<int:formID>', views.UpdatePSL57AFormByUserID.as_view(), name='newpsl57Abyid_'),
