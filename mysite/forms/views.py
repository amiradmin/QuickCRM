    ...
    def post(self, request, *args, **kwargs):
        if request.method == 'POST':
            if 'mainForm' in request.POST:
                ...
                objPSL57.ndtOther = request.POST['ndtOther']
                ...
                objPSL57.testCenterModerator = request.POST['testCenterModerator']
...
class UpdatePSL57BByUserID(SidebarMixin, LoginRequiredMixin, TemplateView):
    template_name = "forms/update_psl_57B.html"

    def get_context_data(self, id, *args, **kwargs):
        context = super(UpdatePSL57BByUserID, self).get_context_data()
        id = self.kwargs['id']
        event = Event.objects.filter(id=self.kwargs['eventID']).first()
        candidate = TesCandidate.objects.filter(id=self.kwargs['id']).first()
...
class updateVisionTestByUserID(SidebarMixin, LoginRequiredMixin, TemplateView):
    template_name = "forms/vision_test_update.html"
    ...
    def post(self, request, *args, **kwargs):
        if request.method == 'POST':
            if 'mainForm' in request.POST:
                ...
                return redirect('forms:updatelecfedform_', id=lecObj.id )
...
class UpdateTrainingAttendancemByID(SidebarMixin, LoginRequiredMixin, TemplateView):
    template_name = "forms/general/update_training_attendance.html"
    ...
    def post(self, request, *args, **kwargs):
        if request.method == 'POST':
            ...
            if 'mainForm' in request.POST:
                ...
                return redirect('forms:updatetwitrainingfeed_' , id=trainingObj.id)
            else:
                print('Here')
                # if request.FILES.get('file', False):
                canID = request.POST['canID']
...
class UpdateTWITrainingFeedback(SidebarMixin, LoginRequiredMixin, TemplateView):
    ...
    def get_context_data(self, id, *args, **kwargs):
        ...
        id = self.kwargs['id']
        form = TwiTrainingFeedback.objects.filter(id=id).first()
        context['form'] = form
        return context
    ...
    def post(self, request, id, *args, **kwargs):
        if request.method == 'POST':
            if 'mainForm' in request.POST:
                ...
                # if not  request.POST.get('contactMe', None) == None:
                #     objPSL57.contactMe =False
                trainingObj = TwiTrainingFeedback.objects.filter(id=id).first()
                trainingObj.startDate = datetime.datetime.strptime(request.POST['startDate'], '%m/%d/%Y')
                trainingObj.lecturerName = request.POST['lecturerName']
                trainingObj.programme = request.POST['programme']
                trainingObj.venue = request.POST['venue']
...
class UpdateTWITrainingFeedbackByUserID(SidebarMixin, LoginRequiredMixin, TemplateView):
    template_name = "forms/update_twi_Training_Feedback.html"
    ...
    def post(self, request, id, *args, **kwargs):
        if request.method == 'POST':
            if 'mainForm' in request.POST:
                ...
                #     objPSL57.contactMe =False
                candidate = TesCandidate.objects.filter(id=id).first()
                trainingObj = TwiTrainingFeedback.objects.filter(candidate=candidate).first()
                trainingObj.startDate = datetime.datetime.strptime(request.POST['startDate'], '%m/%d/%Y')
                trainingObj.lecturerName = request.POST['lecturerName']
                trainingObj.programme = request.POST['programmeOne']
                trainingObj.venue = request.POST['venueOne']
                trainingObj.region = request.POST['regionOne']
                trainingObj.howWeDid = request.POST['howWeDid']
                trainingObj.email = request.POST['emailSS']
