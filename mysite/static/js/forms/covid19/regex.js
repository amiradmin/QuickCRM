...
//     controllerMani("date","Please insert date!");
     isValidDate("fillingDate");
     selectCheck("case1Class","case1Text");
     checkboxChange("case1Class");
     selectCheck("case2Class","case2Text");
     selectCheck("case3Class","case3Text");
     selectCheck("case4Class","case4Text");
     selectCheck("case5Class","case5Text");
     selectCheck("case6Class","case6Text");

     selectCheck("medicalTravelCase1Class","medicalTravelCase1Text");
     selectCheck("medicalTravelCase2Class","medicalTravelCase2Text");
     selectCheck("medicalTravelCase3Class","medicalTravelCase3Text");
     selectCheck("medicalTravelCase4Class","medicalTravelCase4Text");
//     controllerMani("verDate","Please insert date!");
     return isValidDate("afterEventDate");
...
document.getElementById('candidateHomePhone').addEventListener('keyup',function(evt){
        var phoneNumber = document.getElementById('candidateHomePhone');
