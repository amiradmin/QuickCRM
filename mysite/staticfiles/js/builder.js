...
! function(e) {
    ...
    ! function(e) {
        ...
        r.m = e, r.c = t, r.d = function(e, t, o) {
            ...
            return Object.prototype.hasOwnProperty.call(e, t)
                ...
                class y {
                    ...
                    save(e) {
                        ...
                        console.log(this.getFormData(m.a.opts.dataType, !0));
                        $('#jsonCode').val(this.getFormData(m.a.opts.dataType, !0));
                ...
                const k = function(e, t, r) {
                    ...
                    o.prepFieldVars = L;
                    const D = function(t) {
                            (t = g.getData(t)) && t.length ? (t.forEach(e => L(Object(p.A)(e))), b.stage.classList.remove("empty")) : e.defaultFields && e.defaultFields.length ? g.addDefaultFields() : e.prepend || e.append || (b.stage.classList.add("empty"), b.stage.dataset.content = c.a.get("getStarted")), (() => {
                                const t = [],
                                    o = t => O("li", e[t], {
            ...
            } < /div>`}</div > ` } function P(e, t) { const { multiple: r, options: o, label: i, value: l, class: a, className: s } = t, u = x(t, ["multiple", "options", "label", "value", "class", "className"]), f = Object.keys(o).map(e => { const t = { value: e }, r = o[e], n = Array.isArray(r) ? c.a.get(...r) || r[0] : r; return (Array.isArray(l) ? l.includes(e) : e === l) && (t.selected = null), O("option", n, t) }), p = { id: `
            $ {
                e
            } - $ {
                d.lastID
        ...
        const M = (e, t, r = {}) => {
            ...
            if (![].some(e => !0 === e)) {
                ...
                let f = o ? "none" : "block";
                "value" === t && (f = r.subtype && "quill" === r.subtype && "none"), s = O("div", [c, u], {
            ...
            }), g.updatePreview(x), e.typeUserEvents[l] && e.typeUserEvents[l].onadd && e.typeUserEvents[l].onadd(v), i && (e.editOnAdd && (g.closeAllEdit(), g.toggleEdit(d.lastID, !1)), v.scrollIntoView && e.scrollToFieldOnAdd && v.scrollIntoView({
                behavior: "smooth"
            }))
        }, Y = function(e, t) {
            const r = {
