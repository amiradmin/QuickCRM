...
class TicketAnswerAdmin(admin.ModelAdmin):
    list_display = ['id','title','status','department','archived','created_at','updated_at']
...
class TicketAdmin(admin.ModelAdmin):
    list_display = ['id','TicketNumber','candidate','asignedTo','archived','title','status','department','created_at','updated_at']
