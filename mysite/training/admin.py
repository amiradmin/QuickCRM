...
class CandidateProfileAdmin(ImportExportModelAdmin,admin.ModelAdmin):
    ...
    list_display = ['id','user','first_name','customer_id','tes_candidate_id','email','photo','document_1','document_2','sponsor_company','contact_number','city','country','contact_number','birth_date','created_at','updated_at']
    list_filter = ['id','user','first_name','customer_id','tes_candidate_id','email','city','country','contact_number','birth_date','created_at','updated_at']
...
class LecturerAdmin(ImportExportModelAdmin,admin.ModelAdmin):
    ...
    list_display = ['id','user','passport_id','email','photo','document_1','document_2','contact_number','city','country','contact_number','birth_date','created_at','updated_at']
    list_filter = ['id','user','passport_id','email','city','country','contact_number','birth_date','created_at','updated_at']
