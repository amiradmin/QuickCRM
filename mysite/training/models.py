...
class TesCandidate(models.Model):
    ...
    birth_date = models.DateField(null=True, blank=True)
    aboutMe = models.CharField(max_length=5000, null=True, blank=True )
    currentCompany = models.CharField(max_length=512, null=True, blank=True )
    currentPosition = models.CharField(max_length=512, null=True, blank=True )
    ...
    skype = models.CharField(max_length=1024, null=True, blank=True )
    linkedin = models.CharField(max_length=1024, null=True, blank=True )
    skills = models.ManyToManyField('Skill',  null=True, blank=True)
