...
urlpatterns = [
    ...
    path('viewrequest/<int:id>', views.ViewRequestbyID.as_view(), name='viewrequest_'),
    path('archiverequest/<int:id>', views.ArchivedbyID.as_view(), name='archiverequest'),
    path('archivelist/', views.ArchivedbyListView.as_view(), name='archivelist_'),
